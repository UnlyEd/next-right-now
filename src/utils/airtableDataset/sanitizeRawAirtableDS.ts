...
import { RawAirtableAttachmentBaseFields } from '../../types/airtableNativeAPI/RawAirtableAttachmentBaseFields';
...
import { getFieldBestAvailableTranslation } from '../data/airtableField';
