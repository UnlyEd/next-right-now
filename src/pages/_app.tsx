...
import { faArrowCircleRight, faBook, faBookReader, faCoffee, faHome, faUserCog } from '@fortawesome/free-solid-svg-icons';
...
library.add(
  faGithub,
  faArrowCircleRight, faBook, faBookReader, faCoffee, faHome, faUserCog,
  faTimesCircle,
);
