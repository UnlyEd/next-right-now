              ...
              <div>
                <div>
                  <div>
                    ...
                    <I18nLink href={'/examples'} passHref={true}>
                      <a>/examples</a>
                    </I18nLink>{' '}
                    and{' '}
                    <I18nLink href={'/'} passHref={true}>
                      <a>/</a>
                    </I18nLink>{' '}
                    to see CSR in action.
                    <br />
                    You can also disable JS on your browser to see how SSR
                    works.
                    <br />
                    <br />
                    If you want to know a bit more about what's running this
                    demo beneath the surface, check out our{' '}
                    <a href={'/api/status'}>
                  ...
                  <div>
                    ...
                    <br />
                    <br />
                    Every time you visit a page, analytics are automatically
                    sent (similar to Google Analytics "pageviews").
                    <br />
                  </div>
                  ...
                  <div>
                    ...
                    icon below. <br />
                    Changing language refresh the whole page, because it was
                    just simpler to do that instead of running the GraphQL query
                    again. <br />
                  ...
                  <div>
                    ...
                    <br />
                    Please do not use NSFW content or anything that is illegal
                    as we don't enforce any rule. Everybody can change pics and
                    text.
                    <br />
                    <br />
                    ...
                    definition to build the views and GQL queries/mutations.
