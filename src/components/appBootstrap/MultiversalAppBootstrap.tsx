 ...
 * @param props
 */
const MultiversalAppBootstrap: React.FunctionComponent<Props> = (
  props,
): JSX.Element => {
  ...
  if (pageProps.isReadyToRender || pageProps.statusCode === 404) {
    ...
    console.info(
      'MultiversalAppBootstrap - App is not ready yet, waiting for isReadyToRender',
    );
    return null;
  }
};
