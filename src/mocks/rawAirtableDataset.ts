...
import { RawCustomer } from '../types/data/RawCustomer';
import { RawTheme } from '../types/data/RawTheme';
...
const rawAirtableDataset: RawAirtableDataset = {
...
export default rawAirtableDataset;
